...
urlpatterns = [
    ...
    path('logout/', user_view.custom_logout, name='user-logout'),
    path('generate-report/', user_view.generate_order_report, name='generate-order-report'),
    path('download-product-report/', user_view.download_product_report, name='download-product-report'),
    path('get-product-details/<int:product_id>/', user_view.get_product_details, name='get-product-details'),
    path('delete-order/<int:pk>/', user_view.delete_order, name='delete_order'),
